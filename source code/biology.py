...
entry_faculty = ttk.Combobox(frame, values=['Ratna Ghosal', 'Ashutosh Kumar', 'Shomen Mukherjee','Bhuvan Pathak',
                                            'Balaji Prakash','Ashim Rai','Subhash Rajpurohit','Rama Ratnam',
                                            'Balachandran Ravindran', 'Souvik Gupta','Ritesh Shukla','Krishna Swamy',
                                            'Vivek Tanavde','Noopur Thakur'],width=50, style="TCombobox")
