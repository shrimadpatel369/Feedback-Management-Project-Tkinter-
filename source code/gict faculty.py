...
entry_faculty = ttk.Combobox(frame, values=['Shuja Ahmed', 'Jayendra Bhalodiya', 'Rupsa Bhowmick','Sanjay Chaudhary',
                                            ...
                                            'Souvik Roy','Naresh Sharma','Aditi Singhal','Ramya Srinivasan','Mazad Zaveri'],width=50, style="TCombobox")
