...
entry_faculty = ttk.Combobox(frame, values=['Kunal Basu', 'Aditya Chaturvedi', 'Manomohini Dutta','Maya Jasanoff',
                                            'Murari Kumar','Apaar Kumar','Pallavi Narayan','Tejaswini Niranjana',
                                            'Aparajith Ramnath', 'Rahul Sarwate','Shishir Saxena','Charu Singh',
                                            'Joseph Weelden','Guillaume Wadia'],width=50, style="TCombobox")
