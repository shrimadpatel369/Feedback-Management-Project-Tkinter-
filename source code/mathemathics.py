...
entry_faculty = ttk.Combobox(frame, values=['Samyaday Choudhury', 'Soumen Ghosh', 'Gaurav Goswami','Raghwinder Grewal',
                                            'Kaushik Jana','Jitesh Jhawar','Pankaj Joshi','Eshita Mazumdar',
                                            'Sutapa Mukherji', 'Ashwin Pande','Pravakar Paul','Raghavan Rangarajan',
                                            'Manjil Saikia','Alok Shukla','Susanta Tewari','Aditya Vaishya'],width=50, style="TCombobox")
