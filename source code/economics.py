...
entry_faculty = ttk.Combobox(frame, values=['Gaurav Bhattacharya', 'Aryan Chakraborty', 'Sugat Chaturvedi', 'A Damodaran',
                                            ...
                                            'Pallavi Vyas','Sonal Yadav',],width=50, style="TCombobox")
