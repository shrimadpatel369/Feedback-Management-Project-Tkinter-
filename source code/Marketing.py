...
entry_faculty = ttk.Combobox(frame, values=['Atul Kumar', 'Bijal Mehta', 'Ravi Miglani','Prithwiraj Mukherjee',
                                            'Darshana Padia','Mahendra Rao','Zalak Shah','Sujo Thomas'],width=50, style="TCombobox")
